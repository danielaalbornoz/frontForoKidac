...
@Component({
  selector: 'app-sonidoyaudio',
  templateUrl: './sonidoyaudio.component.html',
  styleUrls: ['./sonidoyaudio.component.css']
})
export class SonidoyaudioComponent implements OnInit {
  ...
  mostrarForos() {
    this.foroService.getForos(4).subscribe(
